...
$sql1="SELECT * FROM detail where fullname='$fullname'";
...
<body>
   <div class="sidenav">        
    ...
    <hr style="color">
<br><br>
    <h1 style="text-align: center;">Book Services</h1>
  ...
  <table border="1" style="width:100%" id="table" >
    <thead>
      <tr>
        <th style="width:5%; padding-left:20px;">Service ID</th>
        <th style="width:7%; padding-left:20px;">Service Type</th>          
        <th style="width:5%; padding-left:5px;">Price</th>
        <th style="width:5%; padding-left:30px;">Book</th>
      </tr>
    </thead>
    <?php
          foreach($data as $d) {
    ...
    <tbody>
      <tr>
            <td style='padding-left: 20px;'><?php echo $d['service_id']; ?></td>
            ...
            <td>
              ...
              ?>
               <a href="studentbookservice.php?id=<?php echo $d['service_id']?>"><button style="padding: 5px 10px;;">Book</button></a></td>
             <?php } else{ ?>

              <a href="studentbookservice.php?id=<?php echo $d['service_id']?>"><button style="padding: 5px 10px;" disabled>Book</button></a></td>
        </tr>
    </tbody>
    <?php }} ?>
  </table>
