...
$sql1="SELECT * FROM detail where fullname = '$fullname' ORDER BY booking_number DESC";
...
<div class="content">
    ...
    <hr style="color">
<br><br>
    <h1 style="text-align: center;">Booked Rooms Details</h1>
    <div class="manage">
    <center>
    <table border="1" style="width:100%" id="table">
        <thead>
            <tr>
                <th style="width:11%; padding-left: 6px;">Booking Number</th>
                <th style="width:9%; padding-left: 10px;">Start Date</th>
                 <th style="width:9%; padding-left: 10px;">End Date</th>
                <th style="width:7%; padding-left: 10px;">Student ID</th>                 
                <th style="width:10%; padding-left: 30px;">Fullname</th>
                <th style="width:10%; padding-left: 15px;">Floor Number</th>
                <th style="width:10%; padding-left: 30px;">Room ID</th>
                <th style="width:9%; padding-left: 10px;">Selected Bed</th>                  
            </tr>
        </thead>
        <?php 
        foreach($data as $d){
        ...
        <tbody>
            <tr>
                <td style='padding-left: 10px;'><?php echo $d['booking_number']; ?></td>
                <td style='padding-left: 5px;'><?php echo $d['start_date']; ?></td>
                <td style='padding-left: 5px;'><?php echo $d['end_date']; ?></td>
