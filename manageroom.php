...
<div class="ro">
    ...
    <hr style="color">
<br><br>
  <h3><a href="roomdetail.php">Click Here</a> to add a room.</h3>
  ...
  <table border="1" style="width:100%" id="table">
    <thead>
      <tr>
        <th style="width:7%">Room Id</th>
        <th style="width:12%">Number of Beds</th>
        <th style="width:12%">Floor Number</th>         
      ...
      <tr>
        ...
        <td><?php echo $d['no_of_beds']; ?></td>
            ...
            <td style='padding-left: 10px;'>
              <a href="editform.php?id=<?php echo $d['room_id']?>"><button style="background-color:skyblue; border-color: skyblue; padding: 5px 10px;">Update</button></a>
              <a href="deleteform.php?id=<?php echo $d['room_id']?>"onclick="return confirm('Are you sure you wanna delete?')"><button style="background-color:#C41E3A; border-color: #C41E3A; color: white; padding: 5px 10px;">Delete</button></a>
            </td>
      </tr>
    </tbody>
    <?php } ?>
