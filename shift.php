...
$sql="SELECT * FROM shift where fullname='$fullname'";
...
<br><br>
<?php  
    $queries= "SELECT * from detail where fullname = '$fullname'";
    $rows = mysqli_query($conn,$queries);
    if(mysqli_num_rows($rows) > 0){
?>
     <h3><a href="shiftform.php">Click Here</a> to fill form.</h3>
  <?php } 
  ?>

    <h1 style="text-align: center;">Shifting Details</h1>
  ...
  <table border="1" style="width:100%" id="table" >
    <thead>
      <tr>
        <th style="width:5%; padding-left:20px;">Shift ID</th>
        <th style="width:7%; padding-left:20px;">Student ID</th>
        <th style="width:7%; padding-left:20px;">Fullname</th>          
        <th style="width:5%; padding-left:5px;">Reason</th>
